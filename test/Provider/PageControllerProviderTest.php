...
class PageControllerProviderTest extends ReflectionTestCase
{
    public function testImplementsControllerProviderInterface()
    {
        $reflection = new \ReflectionClass(
            '\\Cekurte\\TwitterLike\\ControllerProvider\\PageControllerProvider'
        );
    ...
    public function testConnect()
    {
        ...
        $this->assertInstanceOf(
            ...
            (new PageControllerProvider())->connect($application)
        );
    }
}
